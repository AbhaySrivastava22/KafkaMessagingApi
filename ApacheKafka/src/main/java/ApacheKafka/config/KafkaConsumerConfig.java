...
public class KafkaConsumerConfig {
    ...
    public Map<String, Object> consumerConfig() {
        ...
        props.put(ConsumerConfig.METADATA_MAX_AGE_CONFIG, 300);
        return props;
    }
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, MessageRequest>> messageFactory(
